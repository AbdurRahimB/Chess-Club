...
This is the result of the HTML validation for index file.
...
From the following site I validated my Stlesheet

[W3C CSS Validation Service](https://jigsaw.w3.org/css-validator/#validate_by_input)

 This is the result of the Stylesheet validation for style.css.
